# PostgreSQL 实时同步至 Elasticsearch

Tapdata Cloud 可以实现数据从 PostgreSQL 数据库到 Elasticsearch 的数据同步，帮助用户轻松实现数据的全文检索。 
...
2. [配置 PostgreSQL 连接](../../prerequisites/certified/postgresql.md)
3. [配置 Elasticsearch 连接](../../prerequisites/alpha/database/elasticsearch.md)
