# SQL Server 实时同步至 PostgreSQL

Tapdata Cloud 可以实现数据从 SQL Server 数据库到 PostgreSQL 的数据同步。 
...
2. [配置 SQL Server 连接](../../user-guide/connect-database/certified/connect-sqlserver.md)
3. [配置 PostgreSQL 连接](../../user-guide/connect-database/certified/connect-postgresql.md)
