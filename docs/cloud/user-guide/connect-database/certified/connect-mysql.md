...
MySQL 是应用最广泛的开源关系数据库，是许多网站、应用程序、商业产品使用的关系数据存储。Tapdata Cloud 支持将 MySQL 作为源和目标数据库构建数据管道，本文介绍如何在 Tapdata Cloud 中添加 MySQL 数据源。
...
[MySQL 实时同步至 BigQuery](../../../best-practice/mysql-as-source/mysql-to-bigquery.md)