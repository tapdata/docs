...
在创建数据开发任务前，请确保您已经配置好了相关数据源，具体操作，见[配置 MongoDB 连接](../user-guide/connect-database/certified/connect-mongodb.md)。
...
5. 单击源库对应的节点，根据下述说明完成右侧面板的配置。
   ...
   2. 完成断点续传和分片设置。
      ...
      ![分片设置](../images/mongodb_to_mongodb_source_advanced_settings.png)
...
6. 单击目标端节点，根据下述说明完成右侧面板的参数配置。
   ...
   2. 下翻至**高级设置**区域框，完成高级设置。
      ...
      ![节点高级设置](../images/mongodb_target_advanced_settings.png)
