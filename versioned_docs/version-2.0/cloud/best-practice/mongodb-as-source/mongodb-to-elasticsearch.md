# MongoDB 实时同步至 Elasticsearch

Tapdata Cloud 可以实现数据从 MongoDB 数据库到 Elasticsearch 的数据同步，帮助用户轻松实现数据的全文检索。 
...
2. [配置 MongoDB 连接](../../user-guide/connect-database/connect-mongodb.md)
