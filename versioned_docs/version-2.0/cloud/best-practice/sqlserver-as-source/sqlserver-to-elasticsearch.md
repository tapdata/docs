# SQL Server 实时同步至 Elasticsearch

Tapdata Cloud 可以实现数据从 SQL Server 数据库到 Elasticsearch 的数据同步，帮助用户轻松实现数据的全文检索。 
...
2. [配置 SQL Server 连接](../../user-guide/connect-database/connect-sqlserver.md)
3. [配置 Elasticsearch 连接](../../user-guide/connect-database/connect-elasticsearch.md)
